...
<html lang="en">
   ...
   <body style = "background-image: url('image/gcoej_image.jpg'); 
    ...
    background-size: cover; " >
               ...
               <div class="card" style = "opacity: 0.85">
                  ...
                  <div class="card-header">
                    <div class="input-group">
					   ...
					   <input id="rohitbtn" type="button" class="btn btn-primary" value="Send" onclick="send_msg()">
					   </span>
					</div> 
                  </div>
               </div>
      ...
      <script type="text/javascript">
			...
			if(txt){
				jQuery.ajax({
					...
					success:function(result){
						var html='<li class="messages-you clearfix"><span class="message-img"><img src="image/gcoej.png" class="avatar-sm rounded-circle"></span><div class="message-body clearfix"><div class="message-header"><strong class="messages-title">GCOEJ</strong> <small class="time-messages text-muted"><span class="fas fa-time"></span> <span class="minutes">'+getCurrentTime()+'</span></small> </div><p class="messages-p">'+result+'</p></div></li>';
						jQuery('.messages-list').append(html);
		...
		if (event.key === "Enter") {
			...
			document.getElementById("rohitbtn").click();
		}
		});
